...
export default function App() {
  ...
  // ==========================================
  // 📸 画像アップロード → GAS経由でGemini解析
  //    APIキーはGAS側のスクリプトプロパティで管理
  // ==========================================
        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md">
          ...
          <form onSubmit={handleStart} className="space-y-6">
            <div>
              ...
              <input type="text" required placeholder="例：グルメ太郎" value={userName}
                            ...
                            {areaShops.map((shop) => (
                              <tr key={shop.id} className={`hover:bg-gray-50 transition-colors ${shop.visited ? 'bg-gray-50 opacity-60' : ''}`}>
                                ...
                                <td className="py-3 px-4">
                                  <input type="text" placeholder="訪問日や感想を書き込めます..."
                                    value={shop.userMemo || ""}

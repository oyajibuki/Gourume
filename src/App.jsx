        ...
        {rateLimitError && (
          <div className="bg-amber-50 border-b border-amber-200 px-4 py-3 flex items-start gap-3">
            ...
            <div className="flex-1 text-sm">
              ...
              <p className="text-amber-700">無料枠の上限：<span className="font-medium">1分間に30回</span> または <span className="font-medium">1日に14,400回</span>まで</p>
              <p className="text-amber-600 text-xs mt-1">1分ほど待ってから再度お試しください。</p>
            </div>
